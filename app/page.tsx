...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <nav className={`fixed w-full z-50 transition-all duration-300 ${scrolled ? 'bg-white shadow-sm' : 'bg-white/95 backdrop-blur-sm'}`}>
          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex items-center">
              <a href="/" className="flex items-center space-x-3">
                ...
                <div className="flex items-center">
                  <span className="font-bold text-2xl text-gray-900">InvestiScope</span>
                  <span className="text-gray-400 text-2xl font-light ml-2">Italy</span>
                </div>
              </a>
            </div>
            ...
            <div className="relative">
              ...
              <div className="relative overflow-hidden rounded-2xl shadow-2xl">
                <Image
                  ...
                  alt="Beautiful Italian villa overlooking the countryside"
                  width={800}
                  height={600}
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h3 className="text-4xl font-light mb-4">Featured Italian Properties</h3>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Handpicked investment opportunities across Italy&apos;s most desirable regions
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
              <div className="relative h-64">
                <Image
                  src="https://images.unsplash.com/photo-1573455494060-c5595004fb6c?w=400&h=300&fit=crop"
                  alt="Trullo in Puglia"
                  width={400}
                  height={300}
                  className="w-full h-full object-cover"
                />
              ...
              <div className="p-6">
                <h4 className="text-xl font-semibold mb-2">Traditional Trullo</h4>
                <p className="text-gray-600 mb-4">Alberobello, Puglia</p>
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                <h4 className="text-xl font-semibold mb-2">Tuscan Villa</h4>
                <p className="text-gray-600 mb-4">Siena, Tuscany</p>
                <div className="flex justify-between text-sm text-gray-500">
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                <h4 className="text-xl font-semibold mb-2">Lakefront Villa</h4>
                <p className="text-gray-600 mb-4">Lake Como, Lombardy</p>
                <div className="flex justify-between text-sm text-gray-500">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <div className="flex items-center space-x-3 mb-4">
                ...
                <span className="font-bold text-xl">InvestiScope Italy</span>
              </div>
